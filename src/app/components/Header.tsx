      ...
      <div className="bg-primary text-primary-foreground py-2 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-4 text-sm">
          ...
          <span className="hidden md:inline">
            | Use code MAMOOJAN10 for 10% Off
          </span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {product.brand} &middot; ${product.price.toFixed(2)}
                      </div>
                    </div>
                  </button>
                ))}
                <div className="p-2 text-xs text-muted-foreground border-t">
                  Popular: Shilajit, Mango Bites, Tongue Scraper
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link
              href="/shop"
              className="hidden sm:flex items-center gap-1.5 text-sm text-foreground hover:text-muted-foreground transition-colors"
            >
            ...
            <Link
              href="/cart"
              className="relative flex items-center gap-1.5 text-sm text-foreground hover:text-muted-foreground transition-colors"
            >
                    ...
                    cat.subcategories.length > 0 && (
                      ...
                      >
                        <div className="grid grid-cols-2 gap-6">
                          <div>
                            <h4 className="text-xs text-muted-foreground mb-3 uppercase tracking-wider">
                              Subcategories
                            </h4>
        ...
        <div className="lg:hidden border-t border-border bg-white max-h-[70vh] overflow-y-auto">
          <nav className="p-4 space-y-1">
            ...
            <div className="border-t pt-3 mt-3">
              <Link
                href="/account"
                className="flex items-center gap-2 py-3 px-3 text-sm text-foreground hover:bg-secondary rounded-lg"
                onClick={() => setMobileMenuOpen(false)}
              >
